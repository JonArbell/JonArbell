...
<div>
  ...
  <ul>
    ...
    <li><strong>💼 Working as a Junior Frontend Developer:</strong> At work we use Vue 3 for the frontend.</li>
    <li><strong>💡 Mindset:</strong> Always curious and learning something new.</li>
    <li><strong>🔥 Tech Stack:</strong> Loving the combo of Spring Boot, Angular, and now Vue 3 — open to exploring more!</li>
    <li><strong>⚡ Fun Fact:</strong> I code almost 8 - 10 hours a day. 😆</li>
  </ul>
</div>
